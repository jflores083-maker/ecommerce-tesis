...
class AcercaScreen extends StatelessWidget {
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  isMobile
                      ? Column(
                          children: _valores().map((v) => Padding(
                            padding: const EdgeInsets.only(bottom: 24),
                            child: _ValorItem(titulo: v.$1, descripcion: v.$2),
                          )).toList(),
                        )
                      : Row(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: _valores().map((v) => Expanded(
                            child: Padding(
            ...
            Container(
              ...
              child: Text('© 2025 638. Buenos Aires, Argentina.',
  ...
  List<(String, String)> _valores() => [
    ('Diseño propio', 'Cada pieza nace de una idea nuestra. Sin fórmulas, sin copias.'),
    ('Producción local', 'Fabricamos en Buenos Aires con materiales seleccionados.'),
    ('Ediciones limitadas', 'Lo que lanzamos no se repite. Cuando se acaba, se acaba.'),
  ];
}
    ...
    return Column(
      ...
      children: [
        ...
        if (config.acercaDescripcion.isNotEmpty) ...[
          ...
          Text(config.acercaDescripcion,
            style: GoogleFonts.dmMono(
              fontSize: 13, color: AppColors.charcoal, height: 2.0,
            ),
          ),
        ],
      ],
