...
class AdminAgregarScreen extends StatefulWidget {
  const AdminAgregarScreen({super.key});

  @override
  State<AdminAgregarScreen> createState() => _AdminAgregarScreenState();
}

class _AdminAgregarScreenState extends State<AdminAgregarScreen> {
  ...
  Future<void> _submit() async {
    ...
    if (titulo.isEmpty || descripcion.isEmpty || precioStr.isEmpty || stockStr.isEmpty) {
      _snack('Completá todos los campos obligatorios', error: true);
      return;
    }
    ...
    if (producto != null && mounted) {
      ...
      _snack('Producto creado correctamente');
    }
  }
                    ...
                    child: Container(
                      ...
                      child: _imagenSeleccionada != null
                          ...
                          : Column(
                              ...
                              children: [
                                const Icon(Icons.add_photo_alternate_outlined, size: 32, color: AppColors.stone),
