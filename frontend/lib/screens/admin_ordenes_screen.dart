...
class _AdminOrdenesScreenState extends State<AdminOrdenesScreen> {
  ...
  static const _estados = ['pendiente', 'pagado', 'enviado', 'entregado', 'cancelado'];
              ...
              child: Column(
                ...
                children: [
                    ...
                    child: Row(
                      children: [
                        _FiltroChip(
                          ...
                          onTap: () { setState(() => _filtroEstado = null); _cargar(); },
                        ),
                        ...
                        ..._estados.map((e) => Padding(
                          ...
                          child: _FiltroChip(
                            ...
                            onTap: () { setState(() => _filtroEstado = e); _cargar(); },
                          ),
                        )),
                      ],
                    ),
                  ...
                  if (_loading)
                    ...
                    Column(
                      children: _ordenes.map((o) => _OrdenCard(
                        orden: o,
...
class _OrdenCardState extends State<_OrdenCard> {
      ...
      builder: (_) => AlertDialog(
        ...
        content: StatefulBuilder(
          builder: (ctx, setLocal) => Column(
            ...
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text('Orden #${widget.orden['ordenId']} — actual: ${_estadoLabel(estadoActual)}',
                style: GoogleFonts.dmMono(fontSize: 11, color: AppColors.stone),
              ),
  ...
  void _pedirSeguimiento(String estado, TextEditingController ctrl) {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        backgroundColor: AppColors.cream,
        title: Text('Número de seguimiento',
          style: GoogleFonts.syne(fontSize: 16, fontWeight: FontWeight.w700, color: AppColors.ink),
        ),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            Text('Opcional. Ingresá el número de seguimiento del envío.',
              style: GoogleFonts.dmMono(fontSize: 11, color: AppColors.stone),
            ),
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                border: OutlineInputBorder(borderSide: BorderSide(color: AppColors.sand)),
                focusedBorder: OutlineInputBorder(borderSide: BorderSide(color: AppColors.ink)),
          ...
          TextButton(
            onPressed: () {
              ...
              _cambiarEstado(estado,
                seguimiento: ctrl.text.trim().isEmpty ? null : ctrl.text.trim());
            },
            child: Text('Confirmar',
              style: GoogleFonts.dmMono(fontSize: 12, color: AppColors.ink, fontWeight: FontWeight.w700),
            ),
          ),
        ],
      ),
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Orden #${o['ordenId']}',
                          style: GoogleFonts.syne(
                            fontSize: 15, fontWeight: FontWeight.w700, color: AppColors.ink,
                          ),
                        ),
                        const SizedBox(height: 2),
                        Text(_formatFecha(o['fecha'] as String),
                  ...
                  // Total
                  Text(_fmt((o['total'] as num).toDouble()),
                    style: GoogleFonts.syne(
                      fontSize: 15, fontWeight: FontWeight.w700, color: AppColors.ink,
                    ),
                  ),
                  ...
                  if (_loadingEstado)
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Text('Cambiar',
                          style: GoogleFonts.dmMono(fontSize: 10, color: AppColors.ink, fontWeight: FontWeight.w700),
                        ),
                      ),
                    ),
                  const SizedBox(width: 12),
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      const Icon(Icons.location_on_outlined, size: 14, color: AppColors.stone),
                  ...
                  if (o['numeroSeguimiento'] != null) ...[
                    ...
                    Row(
                      children: [
                        const Icon(Icons.local_shipping_outlined, size: 14, color: AppColors.stone),
                        const SizedBox(width: 6),
                        Text('Seguimiento: ${o['numeroSeguimiento']}',
                          style: GoogleFonts.dmMono(fontSize: 11, color: AppColors.stone),
                        ),
                      ],
                    ),
                  ...
                  Row(
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          _TotalRow(label: 'Subtotal', valor: _fmt((o['subtotal'] as num).toDouble())),
                          _TotalRow(label: 'Envío', valor: _fmt((o['costoEnvio'] as num).toDouble())),
                          _TotalRow(
                            label: 'Total',
...
Color _estadoColor(String e) {
  switch (e) {
    ...
    case 'pagado': return const Color(0xFF2563EB);
    case 'enviado': return const Color(0xFF7C3AED);
...
List<String> _siguientesEstados(String actual) {
  switch (actual) {
    case 'pendiente': return ['pagado', 'cancelado'];
    case 'pagado': return ['enviado', 'cancelado'];
    case 'enviado': return ['entregado', 'cancelado'];
    default: return [];
  }
}
