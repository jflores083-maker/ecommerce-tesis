...
class ContactoScreen extends StatelessWidget {
                  ...
                  : Row(
                      ...
                      children: [
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: _items(context, email, direccion, horario),
                          ),
                        ),
  ...
  List<Widget> _items(BuildContext context, String email, String direccion, String horario) {
    return [
      ...
      if (email.isNotEmpty)
        _ContactItem(
          ...
          onTap: () async {
            try {
              await launchUrl(Uri.parse('mailto:$email'), webOnlyWindowName: '_blank');
            } catch (_) {}
          },
        ),
    ];
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: Center(
              child: isFa
                  ? FaIcon(icon as FaIconData, size: 18, color: AppColors.charcoal)
...
class _WaBlock extends StatelessWidget {
  ...
  const _WaBlock({required this.numero, required this.telefono, required this.onTap, this.fullWidth = false});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          FaIcon(FontAwesomeIcons.whatsapp, size: 32, color: AppColors.cream),
          const SizedBox(height: 20),
          Text('¿Preferís hablar\ncon nosotros?',
